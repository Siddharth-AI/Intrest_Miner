...
//   // FIXED: Proper click outside detection
//   useEffect(() => {
...
//     }
//   }, [isOpen, triggerRef, notifications]);
...
//           <motion.div
//             ref={dropdownRef}
//             className="fixed w-96 max-h-[90vh] overflow-hidden bg-[#f1f5f9] border border-[#2d3748]/20 shadow-2xl rounded-2xl z-[9999] scrollbar-hide"
//             initial={{ opacity: 0, y: -20, scale: 0.95 }}
//             animate={{ opacity: 1, y: 0, scale: 1 }}
//             exit={{ opacity: 0, y: -20, scale: 0.95 }}
//             transition={{ duration: 0.2, ease: "easeOut" }}>
//             {/* Header */}
//             <div className="p-4 border-b border-[#2d3748]/10 flex items-center justify-between">
//               <div>
...
//                 <button
//                   onClick={onClose}
//                   className="p-1 hover:bg-[#3b82f6]/10 rounded-full transition-colors">
//                   <X className="h-5 w-5 text-[#2d3748] hover:text-[#111827]" />
//                 </button>
//               </div>
//             </div>

//             {/* Tabs */}
//             <div className="flex border-b border-[#2d3748]/10 px-2">
//               <button
...
//                     <div key={date}>
//                       <div className="px-4 py-2 bg-[#3b82f6]/5">
...
//                             {/* Icon */}
//                             <div
//                               className={`flex-shrink-0 h-10 w-10 rounded-full flex items-center justify-center ${getNotificationColor(
//                                 notification.type
//                               )}`}>
//                               {getNotificationIcon(
//                                 notification.type,
...
//                                   {notification.title}
//                                 </p>
//                                 <span className="text-xs text-[#2d3748] whitespace-nowrap ml-2">
//                                   {notification.time}
//                                 </span>
//                               </div>
//                               <p className="text-sm text-[#2d3748] mt-0.5 line-clamp-2">
...
//                                         )
//                                       }
//                                       className="text-xs bg-[#3b82f6]/10 hover:bg-[#3b82f6]/20 transition-colors px-2 py-0.5 rounded text-[#3b82f6] hover:text-[#2563eb]">
//                                       Mark as read
//                                     </button>
//                                   )}
//                                   <button className="text-xs bg-[#3b82f6]/10 hover:bg-[#3b82f6]/20 transition-colors px-2 py-0.5 rounded text-[#2d3748] hover:text-[#111827]">
//                                     View
//                                   </button>
//                                 </div>
//                                 <button
...
//                                     )
//                                   }
//                                   className="text-[#2d3748] hover:text-red-600 transition-colors p-1 hover:bg-red-500/10 rounded">
...
//             {/* Footer */}
//             <div className="p-3 border-t border-[#2d3748]/10 bg-[#3b82f6]/5">
//               <div className="flex justify-between items-center">
//                 <button className="text-sm text-[#2d3748] hover:text-[#111827] transition-colors flex items-center gap-1">
//                   <Settings className="h-4 w-4" />
//                   <span>Notification Settings</span>
//                 </button>
//                 <button className="text-sm text-[#3b82f6] hover:text-[#2563eb] transition-colors flex items-center gap-1">
//                   View All
