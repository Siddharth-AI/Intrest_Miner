        ...
        const defaultPlans = [
            {
                ...
                search_limit: 10,
                duration_days: 30,
                features: JSON.stringify(["10 searches", "30 days access", "Basic support"]),
                sort_order: 1,
            },
            {
                uuid: uuidv4(),
                ...
                search_limit: 1,
                duration_days: 30,
                features: JSON.stringify(["100 searches", "30 days access", "Email support", "Search history"]),
                sort_order: 2,
            },
            {
                uuid: uuidv4(),
                ...
                search_limit: 300,
                duration_days: 30,
                features: JSON.stringify(["300 searches", "30 days access", "Priority support", "Advanced analytics", "Export data"]),
                is_popular: 1,
                sort_order: 3,
            },
        ];
