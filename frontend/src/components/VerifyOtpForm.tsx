...
import { verifyOtp, resetForgotPasswordState } from "../../store/features/forgotPasswordSlice";
  ...
  return (
    ...
    <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-8 shadow-2xl border border-white/20 relative overflow-hidden flex flex-col items-center w-full lg:w-[700px] lg:mr-16">
      <div className="flex flex-col items-center mb-6">
        ...
        <h2 className="text-3xl font-bold mb-2 bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">Verify OTP</h2>
        <p className="text-gray-600">Enter the OTP sent to <span className="font-semibold text-blue-600">{email}</span></p>
      </div>
