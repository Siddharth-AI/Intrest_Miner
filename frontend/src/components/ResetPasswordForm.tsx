...
import { resetPassword, resetForgotPasswordState } from "../../store/features/forgotPasswordSlice";
...
const ResetPasswordForm: React.FC<ResetPasswordFormProps> = ({ resetToken, onReset }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    dispatch(resetPassword({ reset_token: resetToken, new_password: newPassword, confirm_password: confirmPassword }));
  };
  ...
  return (
    ...
    <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-8 w-full lg:w-[700px] shadow-2xl border border-white/20 relative overflow-hidden flex flex-col items-center mr-16">
      <div className="flex flex-col items-center mb-6">
        ...
        <h2 className="text-3xl font-bold mb-2 bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">Reset Password</h2>
