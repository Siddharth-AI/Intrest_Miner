...
// import { Download, Star, TrendingUp, Users, Target, Loader } from "lucide-react";
// import { BusinessFormData, MetaInterest, MetaAPIResponse, MetaRawInterest } from "@/types/business";
// import { useToast } from "@/hooks/use-toast";
// import { generateInterestsWithGPT, fetchInterestFromMeta, analyzeInterestsWithGPT } from "@/services/apiService";
...
//   const [processingStep, setProcessingStep] = useState<string>("Generating interests with AI...");
...
//           completedInterests++;
//           setProgress(Math.round((completedInterests / suggestedInterests.length) * 100));
//         }
...
//         const interestsToAnalyze = rawInterests.length > 500 ?
//           rawInterests.slice(0, 500) : rawInterests;

//         const analyzedInterests = await analyzeInterestsWithGPT(businessData, interestsToAnalyze);
...
//     switch (category) {
//       case "Skill-Based": return "bg-blue-100 text-blue-800";
//       case "Career Intent": return "bg-green-100 text-green-800";
...
//     const csvHeaders = ['Rank', 'Interest Name', 'Audience Size Lower', 'Audience Size Upper', 'Path', 'Topic', 'Relevance Score', 'Category'];
...
//   const totalAudience = interests.reduce((sum, interest) =>
//     sum + ((interest.audienceSizeLowerBound + interest.audienceSizeUpperBound) / 2), 0
//   );
...
//               </div>
//             </div>
//             <h3 className="text-xl font-semibold text-white mb-2">{processingStep}</h3>
//             <div className="w-full bg-white/10 rounded-full h-2.5">
//               <div className="bg-gradient-to-r from-purple-400 to-blue-400 h-2.5 rounded-full" style={{ width: `${progress}%` }}></div>
//             </div>
//             <p className="text-blue-100 text-sm mt-2">
//               This may take a minute as we analyze thousands of potential interests...
//             </p>
//           </div>
//         </CardContent>
//       </Card>
...
//               <div>
//                 <p className="text-sm font-medium text-blue-100">Total Interests Found</p>
...
//               <div>
//                 <p className="text-sm font-medium text-blue-100">Avg. Audience Size</p>
//                 <p className="text-2xl font-bold text-white">
//                   {formatAudienceSize(totalAudience / interests.length, totalAudience / interests.length)}
//                 </p>
//               </div>
//             </div>
//           </CardContent>
...
//               <div>
//                 <p className="text-sm font-medium text-blue-100">Top Relevance Score</p>
//                 <p className="text-2xl font-bold text-white">{Math.max(...interests.map(i => i.relevanceScore))}%</p>
//               </div>
//             </div>
//           </CardContent>
//         </Card>
...
//             <div>
//               <CardTitle className="text-white">Meta Ad Interest Analysis</CardTitle>
//               <CardDescription className="text-blue-100">
//                 AI-generated and ranked interests for {businessData.productName}
//               </CardDescription>
//             </div>
...
//                   <TableHead className="text-blue-100">Rank</TableHead>
//                   <TableHead className="text-blue-100">Interest Name</TableHead>
//                   <TableHead className="text-blue-100">Audience Size</TableHead>
//                   <TableHead className="text-blue-100">Relevance</TableHead>
//                   <TableHead className="text-blue-100">Category</TableHead>
//                   <TableHead className="text-blue-100">Topic</TableHead>
//                 </TableRow>
//               </TableHeader>
//               <TableBody>
...
//                       <div className="flex items-center">
//                         #{interest.rank}
//                         {interest.rank <= 3 && <Star className="w-4 h-4 text-yellow-400 ml-1" />}
//                       </div>
//                     </TableCell>
//                     <TableCell className="text-white font-medium">
//                       <div className="flex items-center">
...
//                           onChange={() => toggleInterestSelection(interest.name)}
//                           className="mr-2"
//                         />
//                         {interest.name}
//                       </div>
...
//                       {formatAudienceSize(interest.audienceSizeLowerBound, interest.audienceSizeUpperBound)}
//                     </TableCell>
//                     <TableCell>
//                       <div className="flex items-center">
//                         <div className="w-12 bg-white/20 rounded-full h-2 mr-2">
//                           <div
//                             className="bg-gradient-to-r from-purple-400 to-blue-400 h-2 rounded-full"
//                             style={{ width: `${interest.relevanceScore}%` }}
//                           ></div>
//                         </div>
//                         <span className="text-white font-medium">{interest.relevanceScore}%</span>
//                       </div>
//                     </TableCell>
//                     <TableCell>
...
//                       </Badge>
//                     </TableCell>
//                     <TableCell className="text-blue-100">{interest.topic}</TableCell>
//                   </TableRow>
//                 ))}
//               </TableBody>
//             </Table>
...
//               <p className="text-white font-medium mb-2">Selected Interests ({selectedInterests.length}):</p>
//               <div className="flex flex-wrap gap-2">
//                 {selectedInterests.map(interest => (
//                   <Badge key={interest} className="bg-purple-600 text-white">
//                     {interest}
//                   </Badge>
//                 ))}
//               </div>
...
//                 onClick={() => {
//                   const selectedData = interests.filter(i => selectedInterests.includes(i.name));
//                   console.log("Selected interests for Meta Ad Manager:", selectedData);
//                   toast({
...
//             <div>
//               <h4 className="text-purple-300 font-medium">Step 1: Business Analysis</h4>
//               <p className="text-blue-100">✓ Collected business information</p>
//               <p className="text-blue-100">✓ Generated AI prompt for {businessData.category} sector</p>
//             </div>
//             <div>
//               <h4 className="text-purple-300 font-medium">Step 2: GPT Interest Generation</h4>
//               <p className="text-blue-100">✓ AI analyzed: {businessData.productName}</p>
//               <p className="text-blue-100">✓ Generated potential relevant interests</p>
//             </div>
//             <div>
//               <h4 className="text-purple-300 font-medium">Step 3: Meta Graph API Query</h4>
//               <p className="text-blue-100">✓ Fetched complete audience data from Meta</p>
//               <p className="text-blue-100">✓ Collected: Name, Audience Size, Path, Topic</p>
//             </div>
//             <div>
//               <h4 className="text-purple-300 font-medium">Step 4: AI Analysis</h4>
//               <p className="text-blue-100">✓ Analyzed data with GPT for best performers</p>
//               <p className="text-blue-100">✓ Ranked and scored for business relevance</p>
//             </div>
//           </div>
//         </CardContent>
//       </Card>
