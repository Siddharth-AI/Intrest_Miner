...
import { forgotPassword, resetForgotPasswordState } from "../../store/features/forgotPasswordSlice";
...
export default function ForgotPasswordForm({ onOtpSent }: ForgotPasswordFormProps) {
